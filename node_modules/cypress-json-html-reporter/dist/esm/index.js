...
import CypressJSONReporter from './lib/CypressJSONReporter.js';;
import HTMLReportGenerator from './lib/HTMLReportGenerator.js';;
module.exports = CypressJSONReporter;
module.exports.CypressJSONReporter = CypressJSONReporter;
...
if (process.argv[2] === 'generate-html') {
  console.log('Running CLI mode for cypress-json-html-reporter.');
  try {
    ...
    generator.convertJSONFolderToHTML(inputFolder).then(() => {
